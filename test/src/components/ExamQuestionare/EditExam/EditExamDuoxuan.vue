<template>
  <div>
    <strong style="font-size: 20px" v-show="score !== 0">[多选] {{ context }}
      ({{ score }})</strong>
    <strong style="font-size: 20px" v-show="score === 0">[多选] {{ context }}</strong>
    <br><br>
    ...
    <transition name="el-zoom-in-top">
      <div v-show="isFold === false" style="margin: 0;padding: 0">
        <br>
        <el-input placeholder="输入题目内容" style="width: 500px" v-model="text2"></el-input>
        &nbsp
        ...
        <div style="margin-top: 20px">
          <el-checkbox-group v-model="checkbox" size="medium">
            <el-checkbox-button v-for="x in newxuanxiang" :label="x">{{ x }}</el-checkbox-button>
          </el-checkbox-group>
          <br>
          可选数量限制&nbsp
          <el-input style="width: 70px" placeholder="max" v-model="min_num"></el-input>
          &nbsp-&nbsp
          <el-input style="width: 70px" placeholder="min" v-model="max_num"></el-input>
          <br><br>
          <!--      <el-radio v-model="radio_1" label="1">本题必做</el-radio>-->
          <!--      <el-radio v-model="radio_1" label="2">本题不必做</el-radio>-->
          正确答案&nbsp&nbsp

          <el-input v-model="true_answer" placeholder="输入正确答案" type="textarea" autosize
                    style="width: 300px"></el-input>
          <br><br>
          题目分值&nbsp&nbsp
          <el-input v-model="score" placeholder="输入题目分值" type="textarea" autosize
                    style="width: 300px"></el-input>
          <br><br>
          本题是否必做&nbsp
...
export default {
  ...
  data() {
    return {
      value: [this.min_num, this.max_num],
      value_1: true,
      radio_1: '',
      checkbox: [],
      text1: '',
  ...
  props: ['context', 'xuanxiang', 'index', 'length', 'max_num', 'min_num', 'describe','must','id','score','true_answer']
}
</script>
