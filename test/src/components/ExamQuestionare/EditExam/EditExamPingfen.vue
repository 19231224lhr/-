<template>
  <div>
    <!--    <h2>评分题编辑功能</h2>-->
    <strong style="font-size: 20px" v-show="score !== 0">[单选] {{ context }}
      ({{ score }})</strong>
    <strong style="font-size: 20px" v-show="score === 0">[单选] {{ context }}</strong>
    <br><br>
    ...
    <transition name="el-zoom-in-top">
      <div v-show="isFold === false" style="margin: 0;padding: 0">
        <br>
        <el-input v-model="text1" placeholder="输入评分题新题目" style="width: 500px" @click="changeContext_1"></el-input>
        &nbsp
        ...
        <br><br>
        设定最高评分&nbsp
        <el-input-number v-model="max_score" @change="handleChange" :min="1" :max="1000" label="描述文字"></el-input-number>
        <br><br>
        <div class="block">
          <el-slider
              v-model="max_score"
...
export default {
  ...
  props: ['context', 'index', 'length','max_score','must','describe','id','score','true_answer']
}
</script>
