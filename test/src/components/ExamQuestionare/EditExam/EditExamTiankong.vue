<template>
  <div>
    <!--    <h2>填空编辑功能</h2>-->
    <strong style="font-size: 20px" v-show="score !== 0">[填空] {{ context }}
      ({{ score }})</strong>
    <strong style="font-size: 20px" v-show="score === 0">[填空] {{ context }}</strong>
    <br><br>
...
export default {
  ...
  props: ['context', 'index', 'length','describe','max_length','must','id','score','true_answer']
}
</script>
