  ...
  <div>
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="正确答案">
        <el-input v-model="ruleForm.true_answer" placeholder="输入正确答案" type="textarea" autosize
                  style="width: 700px"></el-input>
      </el-form-item>
        ...
        if (valid) {
          ...
          if (this.ruleForm.true_xuanxiang === '') {
            ...
            for (i = 0; i <= this.ruleForm.num - 1; i++) {
              ...
              if (this.ruleForm.xuanxiang[i] === '' || this.ruleForm.xuanxiang[i] === undefined || this.ruleForm.xuanxiang[i] === null) {
                test = false
              } else {
                console.log("qwdlkasbcasbv")
          ...
          if (this.isNumber(this.ruleForm.score) === false || this.ruleForm.score <= 0) {
            ...
            alert("有必选项没有填写")
            return false
          } else if (this.ruleForm.xuanxiang.indexOf(this.ruleForm.true_answer) === -1) {
