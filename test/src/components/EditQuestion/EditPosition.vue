<template>
  <div>
    <h3>[评星] {{ context }}&nbsp&nbsp&nbsp<i class="el-icon-key"></i></h3>
    ...
    <transition name="el-zoom-in-top">
      <div v-show="isFold === false" style="margin: 0;padding: 0">
        ...
        &nbsp
        <el-button @click="changeContext">修改内容</el-button>
        <br><br>
        <el-input placeholder="题目说明信息" style="width: 500px" v-model="text2" type="textarea"></el-input>
        &nbsp
        <el-button @click="changeDescribe">修改说明信息</el-button>
        <br>
        <br>
...
export default {
  ...
  props: ['context', 'index', 'length','describe','must','id']
