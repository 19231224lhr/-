  ...
  <div>
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item v-for="(item,index) in ruleForm.num" :label="'选项' + item" prop="xuanxiang">
        <el-input placeholder="填写投票内容" style="width: 500px" v-model="ruleForm.xuanxiang[index]"></el-input> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        <el-input-number v-model="ruleForm.number_xuanxiang[index]" @change="handleChange" :min="0" :max="1000" label="描述文字"></el-input-number>
