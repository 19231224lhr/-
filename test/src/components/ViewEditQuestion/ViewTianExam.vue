<template>
  <div>
    <!--  <h2>填空题浏览编辑</h2>-->
    <strong style="font-size: 20px" v-show="message.score !== 0">[填空] {{ message.title }}
      ({{ message.score }})</strong>
    <strong style="font-size: 20px" v-show="message.score === 0">[填空] {{ message.title }}</strong>
    ...
    <el-input v-model="message.true_answer" placeholder="不输入答案视为开放性试题" type="textarea" autosize
